        ...
        return !pop ? (
            ...
            <div className=" relative pop-page">
                ...
                <div className=' creat-comment-button-div'>
                    <button onClick={() => setIsToggled(!isToggled)} className=' ml-0 mr-0 font-semibold text-base w-52 md:text-xl md:w-64 create-comment-button'>START A CONVO</button>
                ...
                <div className=' my-7 mx-auto w-10/12 h-24 post-comment' key={pops.id}>
                    ...
                    <div>
                        <button className=' absolute right-32 bottom-2 md:right-44 md:bottom-3 bg-transparent font-semibold text-xs text-green-400'>EDIT</button>
                    </div>

                    <div>
                        <button className=' absolute right-20 bottom-2 md:right-32 md:bottom-3 bg-transparent font-semibold text-xs text-red-500'>DELETE</button>
                    </div>
