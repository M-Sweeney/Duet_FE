...
export default function Conversation ({ user, authenticated }) {
    ...
    let navigate = useNavigate()
        ...
        let authenticatedOptions = <div className=" flex justify-evenly relative  text-sm font-semibold mt-8 mb-14 md:text-lg">
        ...
        let publicOptions = <div className='protected'>
